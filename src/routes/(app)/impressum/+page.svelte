<script>
  ...
  <div>
    <section id="impressum-img">
        ...
        style="background-image: url('documents/Menu.jpg'); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
        ...
        <div class="banner-content text-center m-auto" data-aos="zoom-out">
            <h2 class="banner-title display-1 text-white mb-5">{$t("header.contacts")}</h2>
        </div>
