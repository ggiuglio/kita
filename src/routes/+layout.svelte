        ...
        <div class="header-bottom offcanvas offcanvas-end" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                    <li class="py-1"><a href="verein" class="dropdown-item">Verein </a></li>
                    <li class="py-1"><a href="partner" class="dropdown-item">Partner </a></li>
                    <li class="py-1"><a href="spenden" class="dropdown-item">Spenden </a></li>
                    <li class="py-1"><a href="geschichte" class="dropdown-item">Geschichte </a></li>
                ...
                <li class="nav-item px-3 py-2 py-lg-0">
                <a class="nav-link p-0" href="konzeption">Konzeption</a>
                </li>
                <li class="nav-item px-3 py-2 py-lg-0">
                <a class="nav-link p-0" href="anmeldung">Anmeldung</a>
                </li>
                <li class="nav-item px-3 py-2 py-lg-0">
                <a class="nav-link p-0" href="impressum">Impressum</a>
                </li>
