...
/* 
    //isotope
    j('.isotope-container').isotope({
      // options
      itemSelector: '.item',
      layoutMode: 'masonry'
    });

    var grid = j('.entry-container').isotope({
    ...
    // Initialize Isotope
    var container = j('.isotope-container').isotope({
      // options
      itemSelector: '.item',
      layoutMode: 'masonry'
    }); */
   ...
   //active button
      j('.filter-button').click(function () {
        j('.filter-button').removeClass('active');
...
/* 
  ...
  var initJarallax = function () {
    jarallax(root.querySelectorAll(".jarallax"));

    jarallax(root.querySelectorAll(".jarallax-keep-img"), {
      keepImg: true,
    });
  }
    ...
    <div class="swiper slider2">
      <div class="swiper-wrapper">
        <div class="swiper-slide d-flex jarallax position-relative"
          style="background-image: url(images/slider-image.jpg); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
          ...
          <div class="banner-content text-center m-auto" data-aos="zoom-out">
            <h2 class="banner-title display-1 text-white mb-4">Über uns</h2>
          </div>
        ...
        <div class="swiper-slide d-flex jarallax position-relative"
          style="background-image: url(images/slider-image2.jpg); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
...
<section id="uber-uns" class="pt-5">
  ...
  <div class="banner-content text-center m-auto" data-aos="zoom-out">
    <h2 class="display-4 mb-4"> Unsere Kita</h2>
  </div>
  <p class="mb-4">
  ...
  <div class="banner-content text-center m-auto" data-aos="zoom-out">
    <h2 class="display-4 mb-4"> Gemeinsam</h2>
  </div>
  <p class="mb-4">
